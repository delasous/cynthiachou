        ...
        <div className='h-full md:max-w-2/3 md:pt-4 w-4/5 self-center flex flex-col md:pl-2'>
            ...
            <Container title={'Guidelines & Documentation'}>                    
                <div className='flex flex-col flex-wrap'>
                    ...
                    <div className='flex flex-row flex-wrap justify-center'>
                        <div className='min-w-48 max-w-56 h-auto justify-self-center p-2 transform hover:scale-175 hover:z-10'>
                            <img src={`/HelloFresh/Hello1.svg`} />
                        </div>
                        <div className='min-w-48 max-w-112 h-auto p-2 transform hover:scale-200 hover:z-10'>
            ...
            <Container title='Workflows'>                    
                <div className='flex flex-col flex-wrap'>
                    ...
                    <div className='min-w-48 max-w-104 h-auto p-2 mx-auto transform hover:scale-150 hover:z-10'>
            ...
            <div className='w-100 h-auto flex flex-row content-between overflow-x-scroll'>
                    {
                     showcase.map((x) => {
                         return (
                            <div className='min-w-64 max-w-64 h-auto p-2'>
